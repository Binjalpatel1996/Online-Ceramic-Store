<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Faq_form.aspx.cs" Inherits="Faq_form" %>
...
<br />
   ...
   <div>
    ...
    <td class="style1">
    <asp:TextBox ID="TextBox3" runat="server" Rows="4" Columns="20" TextMode="MultiLine"></asp:TextBox>
    </td>
    </tr>
    <tr>
    <td align="right">
