...
<section class="sub_header">
 ...
 <asp:HyperLink href= '<%#Eval("ImagePath") %>'  rel="lightbox[image]" runat="server"></asp:HyperLink> <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("ImagePath") %>' Height="200px" Width="200px"/>
        </ItemTemplate>
        </asp:Repeater>
    </div>   
    </form></section> 
