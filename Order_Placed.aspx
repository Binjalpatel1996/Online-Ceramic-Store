<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Order_Placed.aspx.cs" Inherits="Order_Placed" %>
...
<section class="sub_header">
    ...
    <table>
    <tr>
        <td colspan="10px" class="style2" align="left" style="color: #FF6600; font-style: inherit; font-size:x-large; font-family: 'Times New Roman', Times, serif; ">
        1.ORDER SUMMARY
        </td>
        </tr>
    </table>
    ...
    <div>
    <center>
    <table style="background-color:#F2F2F2; border-top-color: #2b2b2b; border-right-color: #2b2b2b; border-bottom-color: #2b2b2b; border-left-color: #2b2b2b; color: #2b2b2b ">
        
        <tr>
            <td class="style2" align="left" style="border-style: hidden; font-size: Medium" >
        ...
        <tr>
        <td align="right" class="style2" style="font-size:Medium">
            Payable Amount: <asp:Label ID="Label1" runat="server" Text=""></asp:Label></td>
        </tr>
        </table>
    </center>
    </div>
  ...
  <center>
   ...
   <td style="color: #000000" class="style1">
   India(Service available only in india)
   </td>
   </tr>
   <tr>
   <td class="style2" align="left" style="font-size:Medium;color: #000000;">
   ...
   <tr>
   <td align="right">
   <asp:Button ID="Button1" runat="server" Text="SAVE & CONTINUE"  Width="170px" 
          Height="40px" onclick="Button1_Click"></asp:Button>
   </td>
   </tr>
   </table>
  </center>
...
<table>
<tr>
<td  align="center"class="style2" style="font-size:Medium;color: #000000;">
Cash On Delivery
</td>
</tr>
...
<asp:Button ID="Button2" runat="server" Text="CONFIRM ORDER" Width="180px" 
