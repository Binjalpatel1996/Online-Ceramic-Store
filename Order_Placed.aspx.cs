...
#pragma warning restore IDE1006 // Naming Styles
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        MailMessage Msg = new MailMessage("epicceramic1@gmail.com", TextBox5.Text, "Confirmation Order !!", "Hi, Customer,This is your Total Payable Amount is :" + Label1.Text + "Thank you for Shopping <br> Have a nice day !!")
        {
            IsBodyHtml = false
        };
        NetworkCredential mailAuthentication = new NetworkCredential("epicceramic1@gmail.com", "8401588874");

        SmtpClient mailClient = new SmtpClient("epicceramic1@gmail.com", port: 25)
        {
