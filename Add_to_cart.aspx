<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_to_cart.aspx.cs" Inherits="Add_to_cart" %>
...
<tr>
<td colspan = "6">
<asp:Button ID="Button2" runat="server" Text="Back" onclick="Button2_Click"></asp:Button>
</td>
</tr>
</table>
</div>
            ...
            <table>
               <tr>
                 <td style="color: #CC0000">
                  ...
                  <ItemTemplate>
                  <table style="border: 1px solid #FF6600; background-color: #F2F2F2" cellpadding="5"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; color: #CC0000;">
                                                    <table>
                                                        <tr>
                                ...
                                <tr>
                                                            <td class="style2" align="right" style="font-size: Medium; color: #CC0000;">
                                                                <b>Quantity</b>
...
<center>
     <table>
     <tr>
     <td align="right" style="font-size: large; font-style: inherit">
     <asp:Button ID="btnAddOrder" runat="server" Text="Buy Now" 
             onclick="btnAddOrder_Click" ></asp:Button>
    </td>
     </tr>
     </table>
     </center>
