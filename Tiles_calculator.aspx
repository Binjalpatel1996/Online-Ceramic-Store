<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tiles_calculator.aspx.cs" Inherits="Tiles_calculator" %>
...
<section class="sub_header">
  ...
  <tr>
    ...
    <td class="style1">
        <asp:Label ID="Sqft" runat="server" Text=""></asp:Label>
    </td>
    </tr>
    <tr>
    <td >
    ...
    <td>
    <asp:Label ID="tilesneeded" runat="server" Text=""></asp:Label>
    </td>
    </tr>
    </table>
    </center>
