...
<br />
    ...
    <table style="background-color:#F2F2F2; border-top-color: #2b2b2b; border-right-color: #2b2b2b; border-bottom-color: #2b2b2b; border-left-color: #2b2b2b; color: #2b2b2b ">
        ...
        <tr>
            <td>
                 <asp:Button ID="Button2" runat="server" Text="Update Order" onclick="Button2_Click"></asp:Button>
            </td>
            <td align="right">
                 <asp:Button ID="Button1" runat="server" Text="Remove Order" onclick="Button1_Click"></asp:Button>
            </td>
        </tr>
        <tr>
            <td align="right"class="style2"style="font-size:Medium">
                 Payable Amount: <asp:Label ID="Label1" runat="server" Text=""></asp:Label>
            </td>
        </tr>
    </table>
   </center>
  ...
  <tr>
  <td  style="font-size: xx-large; font-style: inherit; font-weight: bold;">
     <asp:Button ID="Button3" runat="server" Text="Place Order " Width="150px" 
          Height="40px" onclick="Button3_Click"></asp:Button>
  </td>
  </tr>
  </table>
  </center>
