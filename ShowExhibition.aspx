<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowExhibition.aspx.cs" Inherits="ShowExhibition" %>
...
<section class="sub_header">
 ...
 <form id="form1" runat="server">
    <div>
    <center>
    <table  style="font-size:x-large; font-style: inherit"  >
    <tr>
    <td class="style2" >
    <asp:LinkButton ID="LinkButton1" runat="server" >Concluded</asp:LinkButton>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    
    <td class="style1">
    <asp:LinkButton ID="LinkButton2" runat="server">Upcoming</asp:LinkButton>
    </td>
    </tr>
    </table>
    </center>
    ...
    <td >
     <asp:Label ID="Label1" runat="server" Text='<%#Eval("Title") %>' Font-Size="Medium"></asp:Label>
     </td>
     <td  class="style1"align="left" style="font-size: Medium">
     <b>Date:</b>
     </td>
     <td>
     <asp:Label ID="Label2" runat="server" Text='<%#Eval("Date") %>' Font-Size="Medium"></asp:Label>
     </td>
     <td  class="style1" align="left" style="font-size: Medium">
    <b>Venue:</b> 
     </td>
     <td>
     <asp:Label ID="Label3" runat="server" Text='<%#Eval("Venue") %>' Font-Size="Medium"></asp:Label>
     </td>
     </tr>
     <tr>
     <td class="style1" align="left" style="font-size: Medium">
     <asp:Button ID="Button1" runat="server" Text="View Images" CommandName="Image" CommandArgument='<%#Eval("Exhibition_ID") %>' Font-Size="Medium"></asp:Button>
     </td>
     </tr>
     </table>
     </ItemTemplate>
