<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Glazed_tiles.aspx.cs" Inherits="Glazed_tiles" %>
   ...
   <table>
     <tr>
       ...
       <asp:ListItem> ---Select Type Of Product--- </asp:ListItem>
        ...
        <td>
        <asp:Button ID="Button1" runat="server" Text="Search" onclick="Button1_Click1"  ></asp:Button>
        </td>
       </tr>
       </table>
   </div>
